...
export default function Schedule() {
  ...
  return (
    <section id="schedule" className="section-pad bg-gradient-to-b from-cream-100 to-cream-50">
      <div ref={ref} className={`mx-auto max-w-7xl reveal ${isVisible ? 'is-visible' : ''}`}>
                  ...
                  <div className="lg:w-1/2">
                    ...
                    >
                      ...
                      <div className="p-6">
                        ...
                        <p className="text-sm leading-relaxed text-charcoal-700/70">{event.desc}</p>
                      </div>
                    </div>
                  </div>
