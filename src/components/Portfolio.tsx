    ...
    >
      ...
      >
        ...
        <div className="services-feature mt-20 grid overflow-hidden border-y border-[#171614]/10 lg:grid-cols-[1.1fr_0.9fr]">
          ...
          <div className="services-feature-image group relative min-h-[360px] overflow-hidden sm:min-h-[450px] lg:min-h-[650px]">
            <img
          ...
          <div className="flex flex-col justify-between bg-[#1b1916] p-8 text-[#f4f0e8] sm:p-12 lg:p-16">
            <div>
              ...
              <h3 className="mt-14 max-w-xl font-serif text-4xl font-normal leading-tight sm:mt-20 sm:text-5xl">
                {services[0].title}
              </h3>
...
function ServiceRow({
  ...
  return (
    <div className="service-row group relative border-b border-[#171614]/10">
      <div className="grid gap-5 py-7 lg:min-h-[120px] lg:grid-cols-[80px_1fr_1fr_80px] lg:items-center lg:py-8">
        {/* Number */}
      ...
      <div className="mb-7 overflow-hidden rounded-sm sm:mb-8 lg:hidden">
        <img
          src={service.image}
          alt={service.title}
          loading="lazy"
